...
class CartRepo {
  ...
  List<CartModel> getCartHistoryList() {
    ...
    // now we need to convert the list of history cart into a CartModel

    List<CartModel> cartListHistory = [];

    // Below line will convert the list of cart item into cart Model
  ...
  void removeCart() {
    cart = [];
    sharedPreferences
        .remove(AppConstants.CART_LIST); // for removing data from local storage
  }
}
